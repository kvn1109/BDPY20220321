...
pt1 = [25.052045692964818, 121.5439543746741]
pt2 = [25.052862128643984, 121.52039385115964]
folium.Circle(pt1, radius=300, popup='nanjing-fuxing', fill_color='#C0FFEE').add_to(osm)
folium.CircleMarker(pt2, radius=300, popup='zhung-shan', fill_color='#FFC0EE').add_to(osm)
